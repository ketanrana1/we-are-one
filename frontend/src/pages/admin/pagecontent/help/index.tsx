...
export default function AddHelpAndSupportContent() { 
    ...
    const validate = () => {
      ...
      const handleSubmit = async (e) => {
        ...
        form.append('page_name', "Help And Support");
        ...
        try {
            ...
            method: 'post',    
            url: 'http://localhost:4000/api/addContent/HelpAndSupport/',
            data: form,
            headers: {
    ...
    return (
            <div className="admin-cmmn-frm addBook-form">
                <h3 className="mb-3">Add Help and Support Content</h3>
...
AddHelpAndSupportContent.getLayout = function getLayout(page) {
    return (
      <AdminLayout>
            {page}
      </AdminLayout>
