...
export default function AddPrivacyPolicyContent() { 
    ...
    const validate = () => {
      ...
      const handleSubmit = async (e) => {
        ...
        form.append('page_name', "Privacy Policy");
        ...
        try {
            ...
            method: 'post',    
            url: 'http://localhost:4000/api/addContent/privacyPolicy/',
            data: form,
            headers: {
    ...
    return (
            <div className="admin-cmmn-frm addBook-form">
                <h3 className="mb-3">Add Privacy Policy Content</h3>
...
AddPrivacyPolicyContent.getLayout = function getLayout(page) {
    return (
      <AdminLayout>
            {page}
      </AdminLayout>
