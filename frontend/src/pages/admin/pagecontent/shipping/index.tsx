...
export default function AddShippingContent() { 
    ...
    const validate = () => {
      ...
      const handleSubmit = async (e) => {
        ...
        form.append('page_name', "Shipping");
    ...
    return (
            <div className="admin-cmmn-frm addBook-form">
                <h3 className="mb-3">Add Shipping Content</h3>
...
AddShippingContent.getLayout = function getLayout(page) {
    return (
      <AdminLayout>
            {page}
      </AdminLayout>
